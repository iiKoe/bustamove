...
public class MainMenuScreen implements Screen{
	...
	public void render(float delta) {
		...
		if (Gdx.input.getX() < center_width(PLAY_BUTTON_WIDTH) + PLAY_BUTTON_WIDTH && 
				Gdx.input.getX() > center_width(PLAY_BUTTON_WIDTH) && 
				game.getGameHeight() - Gdx.input.getY() < center_height(PLAY_BUTTON_HEIGHT) + PLAY_BUTTON_HEIGHT &&
				game.getGameHeight() - Gdx.input.getY() > center_height(PLAY_BUTTON_HEIGHT))
		{
			game.batch.draw(playButtonActive, 
					...
					center_height(PLAY_BUTTON_HEIGHT), 
					PLAY_BUTTON_WIDTH, 
					PLAY_BUTTON_HEIGHT);
